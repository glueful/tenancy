 ...
 * one tenant's work unwinds cleanly and does not leak its tenant into the next iteration. Inactive
 * / archived tenants are skipped (only status='active' rows are iterated).
 *
...
final class ForEachTenant
{
     ...
     */
    public static function run(ApplicationContext $context, callable $work): void
    {
